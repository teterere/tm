<template>
    ...
    <span v-else @click="enableEditStatus" class="w-full hover:bg-gray-100 rounded-xs p-1 pl-2 text-sm text-gray-600 cursor-text min-h-[1.75rem]">
...
const submit = () => {
    ...
    disableEditStatus();
    emit('update', {field: 'estimate', value: form.estimate});
};
</script>
