<template>
    <AppLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center p-8">
            <div>
                <h3 class="text-5xl font-bold text-gray-700 mb-8">Par izstrādātāju</h3>
                ...
                <div class="flex gap-6 mt-8">
                    ...
                    <button
                        @click="openDemo"
                        class="btn flex items-center space-x-2 bg-indigo-600 text-white hover:bg-indigo-500 focus-visible:outline-indigo-600 px-3.5 py-2.5 text-sm">
                        Atvērt Demo kontu
                    </button>
